      ...
      <div className="main-content">
        <div className="contact-page">
          ...
          <header className="contact-header">
            ...
            <div className="contact-header-right">
              <button 
                className="btn-submissions-toggle" 
                onClick={() => setShowContacts(!showContacts)}
              >
                {showContacts ? "✕ Close Submissions" : "📋 View My Submissions"}
              </button>
            </div>
          </header>
        ...
        <div className="contact-section">
          ...
          <div className="contact-info">
            <a href="mailto:bilalchannar01@gmail.com" className="contact-email">
          ...
          <div className="contact-form-container">
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              {/* Row 4: Button centered full width */}
          ...
          {showContacts && (
            <div className="submissions-section">
              <div className="submissions-header">
                ...
                <p>Track your support requests and status</p>
              </div>
              
              <div className="submissions-grid">
                {contacts.length > 0 ? (
                  contacts.map((contact, idx) => (
                    <div key={contact._id || idx} className="submission-card">
                      ...
                      <div className="submission-body">
                        ...
                        <div className="submission-meta">
                          <span className="submission-email">{contact.email}</span>
                          <span className="submission-subject">Topic: {contact.subject}</span>
                        </div>
